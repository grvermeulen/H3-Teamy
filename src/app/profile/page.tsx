      ...
      <div className="container">
        ...
        {needsLink ? (
          ...
          >
            ...
            >
              <div className="muted">
                We found RSVPs on this device. Import them into your account?
              </div>
              <button type="button" disabled={adopting} onClick={adopt}>
                Import
              </button>
            </div>
          </div>
        ...
        <div className="card" style={{ maxWidth: 520 }}>
          <div className="row" style={{ marginBottom: 12 }}>
            ...
            <div className="muted">
              ...
              {roles.admin && (roles.trainer || roles.player) ? ", " : ""}
              {roles.trainer ? "Trainer" : null}
              {roles.trainer && roles.player ? ", " : ""}
              {roles.player ? "Player" : null}
            </div>
          </div>
          <div
            className="row"
          ...
          >
            ...
            {attendanceBadge ? (
              <>
                <div className={`badge badge-${attendanceBadge.slug}`}>
          ...
          <div className="row" style={{ gap: 12 }}>
            <div className="grow">
              <label className="muted" htmlFor="first">
                First name
              </label>
              <input
                id="first"
            ...
            <div className="grow">
              <label className="muted" htmlFor="last">
                Last name
              </label>
              <input
                id="last"
